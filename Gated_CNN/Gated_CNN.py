...
def before_train(train_A_dir, train_B_dir, model_dir, output_dir, tensorboard_log_dir):
    ...
    list_A= auto_list(train_A_dir,nat_sort=True)
    list_B= auto_list(train_B_dir,nat_sort=True)
...
#    coded_sps_A_norm = pre.transpose_in_list(lst = data_ppg)#coded_sps_ppg_transposed
...
#            Eva_list_A=pre.load_data_list(validation_A_dir)  
            Eva_list_A = auto_list(validation_A_dir,nat_sort=True)
...
#            Eva_list_A=glob.glob(tmp)  
            ...
            if epoch % 50 == 0:
                ...
                for filepath in tqdm(Eva_list_A,desc='Generating'):
                    ...
                    tPPG=f['ppgmat'][:]#PPG_by_wave
                    coded_sp_norm = tPPG #tPPG.T
...
# For Debug default
    train_A_dir_default = r'E:\Wayne\Code\Cycel_GAN\data\Training\Wang\Aug2'
    train_B_dir_default = r'E:\Wayne\Code\Cycel_GAN\data\Training\YU\Aug2'
    model_dir_default = './model/Wang_PPG2mel_Aug2'
    model_name_default = 'Wang_PPG2mel_Aug2.ckpt'
    initial_model_default = None
#    initial_model_default = './model/Wang_PPG2mel_new/Wang_PPG2mel_new.ckpt'
#    initial_model_default = './model/Wang_PPG2mel/Wang_PPG2mel.ckpt'
    random_seed_default = 0
    validation_A_dir_default = r'E:\Wayne\Code\Cycel_GAN\data\Evaluating\Wang\Aug2'#./mat/Evalu_List_PPG.mat'
