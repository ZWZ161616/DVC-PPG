...
def main():
    ...
    hp.data_path = r'data_processed/AISHELL_F'
    path_input_tts_latest_weights = r'pretrained\ljspeech.tacotron.r2.180k/latest_weights.pyt'
    path_input_tts_latest_optim   = r'D:\CCC_PC\20191118_DASRTTS\WaveRNN-master\model_outputs\huang_ten\tts/taco_step110K_optim.pyt'
    model_id = 'AISHELL_F_TransferFromLJ'
