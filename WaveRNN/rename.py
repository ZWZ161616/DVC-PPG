# -*- coding: utf-8 -*-
"""
Created on Fri Mar 13 17:21:26 2020

@author: e7789520
"""

import os
path=r'F:\Kevin\DTW_Ho_Haung\two/' #這就是欲進行檔名更改的檔案路徑，路徑的斜線是為/，要留意下！
...
for i in files: #因為資料夾裡面的檔案都要重新更換名稱
	...
	newname=path+'Haung2_'+files[n] #在本案例中的命名規則為：年份+ - + 次序，最後一個.wav表示該檔案的型別
