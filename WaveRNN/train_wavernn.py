...
#    paths = Paths(hp.data_path, hp.voc_model_id, hp.tts_model_id)
    ...
    #     
    # =============================================================================
    # hp.data_path = r'E:\Code\Python\WaveRNN\WaveRNN_CCC\data_processed\LDV2EGG'
    # path_input_tts_latest_weights = r'E:\Code\Python\WaveRNN\WaveRNN_CCC\model_outputs\YU_80\YU_80.wavernn\wave_step219K_weights.pyt'
    # path_input_tts_latest_optim   = r'E:\Code\Python\WaveRNN\WaveRNN_CCC\model_outputs\YU_80\YU_80.wavernn\wave_step219K_optim.pyt'
    hp.data_path = r'E:\Code\Python\WaveRNN\WaveRNN_CCC\data_processed\YU_80'
    path_input_tts_latest_weights = r'E:\Code\Python\WaveRNN\WaveRNN_CCC\model_outputs\YU_80\YU_80.wavernn\wave_step219K_weights.pyt'
    path_input_tts_latest_optim   = r'E:\Code\Python\WaveRNN\WaveRNN_CCC\model_outputs\YU_80\YU_80.wavernn\wave_step219K_optim.pyt'
    # path_input_tts_latest_weights = r'E:\Code\Python\WaveRNN\WaveRNN_CCC\pretrained\ljspeech.wavernn.mol.800k\latest_weights.pyt'
    # path_input_tts_latest_optim   = r'E:\Code\Python\WaveRNN\WaveRNN_CCC\model_outputs\YU_80\YU_80.wavernn\latest_optim.pyt'
    model_id = 'YU_80'

    paths = Paths(hp.data_path, model_id, model_id, path_input_tts_latest_weights, path_input_tts_latest_optim)
