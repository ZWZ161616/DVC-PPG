...
wav_path = 'Data_raw/YU'
data_path = 'data/'

# model ids are separate - that way you can use a new tts with an old wavernn and vice versa
# NB: expect undefined behaviour if models were trained on different DSP settings
voc_model_id = 'YU_wavernn'
tts_model_id = 'YU_wavernn_attention'
...
fft_bins = n_fft // 2 + 1
num_mels = 80
hop_length = 160#275                    # 12.5ms - in line with Tacotron 2 paper
win_length = 400#1100                   # 50ms - same reason as above
fmin = 40
min_level_db = -100
ref_level_db = 20
...
voc_batch_size = 32
voc_lr = 1e-4
voc_checkpoint_every = 1000#25000
